...
namespace Services.Tests.MyHealth
{
    public class AggregationCalculatorTests
    {
        ...
        public void ShouldSetMovingAveragesOnWeightsWithFullSeedList()
        {
            ...
            Assert.Equal(55, resultWeights[0].MovingAverageKg);
            Assert.Equal(65, resultWeights[1].MovingAverageKg);
            Assert.Equal(75, resultWeights[2].MovingAverageKg);
        ...
        public void ShouldSetMovingAveragesOnBloodPressureWithFullSeedList()
        {
            ...
            Assert.Equal(55,   resultBloodPressures[0].MovingAverageSystolic);
            Assert.Equal(65,   resultBloodPressures[1].MovingAverageSystolic);
            Assert.Equal(75,   resultBloodPressures[2].MovingAverageSystolic);
            ...
            Assert.Equal(60,   resultBloodPressures[0].MovingAverageDiastolic);
            Assert.Equal(70,   resultBloodPressures[1].MovingAverageDiastolic);
            Assert.Equal(80,   resultBloodPressures[2].MovingAverageDiastolic);
