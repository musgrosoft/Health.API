...
namespace Utils
{
    public class Logger : ILogger
    {
        ...
        public void Error(Exception ex)
        {
            ...
            var content = new StringContent("{\"message\": \"" + System.Web.HttpUtility.JavaScriptStringEncode(ex.ToString()) + "\", \"timestamp\" : " + DateTime.Now.ToString("yyyy-MM-ddTHH:mm:ss.SSSZ") + "}");
        ...
        public void Log(string message)
        {
            ...
            var content = new StringContent("{\"message\": \"" + System.Web.HttpUtility.JavaScriptStringEncode(message) + "\", \"timestamp\" : " + DateTime.Now.ToString("yyyy-MM-ddTHH:mm:ss.SSSZ") + "}");
            var httpClient = new HttpClient();
            httpClient.PostAsync(requestUri, content);
