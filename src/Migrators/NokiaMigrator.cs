...
{   
    public class NokiaMigrator
    {
        ...
        public async Task MigrateWeights()
        {
            ...
            _logger.Log($"NOKIA - WEIGHT - Latest Weight record has a date of : {latestWeightDate:dd-MMM-yyyy HH:mm:ss (ddd)}");
        ...
        public async Task MigrateBloodPressures()
        {
            ...
            _logger.Log($"NOKIA - BP - Latest Blood Pressure record has a date of : {latestBloodPressureDate:dd-MMM-yyyy HH:mm:ss (ddd)}");
